...
class ReviewersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reviewer" do
    assert_difference('Reviewer.count') do
      post reviewers_url, params: { reviewer: { name: @reviewer.name, password_digest: @reviewer.password_digest } }
    end
  ...
  test "should update reviewer" do
    patch reviewer_url(@reviewer), params: { reviewer: { name: @reviewer.name, password_digest: @reviewer.password_digest } }
